...
class Contingency extends DTEModel
{
    ...
    {
        $contingencyType = $this->getContingencyType();
        $contingencyCode = intval($contingencyType->getCode());
        $contingencyReason = $this->getContingencyReason() ?? $contingencyType->getName();
        ...
        return [
            ...
            'motivo' => [
                ...
                'tipoContingencia' => $contingencyCode,
                'motivoContingencia' => $contingencyReason,
            ],
        ];
    }
}
